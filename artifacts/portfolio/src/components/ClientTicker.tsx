            ...
            {INDUSTRIES.map((item) => {
              ...
              return (
                <div
                  ...
                  className={`flex flex-col items-center justify-center gap-2 px-4 py-3 rounded-xl text-center text-xs font-medium transition-all duration-200 border cursor-default ${
                    isHovered
