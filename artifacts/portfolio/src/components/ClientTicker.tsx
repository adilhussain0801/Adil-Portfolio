...
// Initial positions spread across canvas - pushed to edges for spacing
const PILL_INIT = [
  [90, 40], [480, 20], [850, 100], [700, 390],
  [240, 470], [30, 270], [860, 480], [450, 280],
  [640, 420], [770, 180], [200, 140],
];
...
const DOT_INIT = [
  ...
  // Additional dots around IoT area and whitespace
  [120, 380, 4], [100, 420, 5], [160, 440, 3], [320, 420, 4],
  [280, 360, 5], [180, 380, 3], [140, 300, 4],
  // More dots in center and around
  [380, 240, 4], [400, 380, 5], [520, 420, 3], [620, 320, 4],
  [560, 360, 5], [680, 300, 3], [740, 260, 4],
];
