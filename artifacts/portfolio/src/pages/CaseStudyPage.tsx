  ...
  if (groups && groups.length > 0) {
    return (
      ...
      >
                      ...
                      <div className="relative grid grid-cols-5">
                        ...
                        {steps.map((step, i) => (
                          <div key={i} className="flex justify-center relative z-10">
                            ...
                            <div className="rounded-full p-2" style={{ background: "#F5F5F7" }}>
                              <div
        ...
        <div className="h-screen snap-start snap-always flex flex-col items-center justify-center" style={{ background: "#F5F5F7" }}>
          <SnapReveal>
    ...
    >
      <SnapReveal>
        <div className="max-w-3xl mx-auto w-full px-8">
          ...
          <p className="text-sm text-[#1a1a1a]/50 mb-6" style={{ fontFamily: FF }}>Structure value into clear, purchasable choices</p>
          ...
          <div
            ...
            style={{ background: "rgba(232,101,75,0.07)", border: "1px solid rgba(232,101,75,0.20)" }}
          >
            <Sparkles size={16} className="flex-shrink-0" style={{ color: "#C05437" }} />
            <p className="text-sm" style={{ fontFamily: FF }}>
              <span className="font-bold text-[#C05437]">One app</span>
              <span className="text-[#1a1a1a]/65"> → multiple value propositions, each priced to match what customers actually need.</span>
            </p>
          </div>
        ...
        <div className="max-w-2xl mx-auto w-full px-8 flex flex-col gap-7">
          ...
          <div className="grid grid-cols-2 gap-3">
            {systems.map((s) => (
              <div
                key={s.label}
                className={`rounded-2xl px-4 py-4 flex flex-col items-center justify-center text-center gap-2${s.label === "Commerce platform" ? " col-span-2" : ""}`}
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", marginBottom: 16 }}>
        <span style={{
          fontFamily: FF, fontSize: 9, fontWeight: 700, letterSpacing: "0.12em",
...
function SectionNav({ study, scrollRef }: { study: CaseStudy; scrollRef: RefObject<HTMLDivElement> }) {
  ...
  const sections = useMemo(() => [
    ...
    { id: "section-process", label: study.id === 4 ? "Competitors" : "Ecosystem" },
    ...
    ...(study.id === 3 ? [{ id: "section-core-problem", label: "Core Problem" }] : []),
    ...(study.id === 3 ? [{ id: "section-evaluation-journey", label: "Evaluation" }] : []),
    ...(study.id === 3 ? [{ id: "section-customer-reality", label: "Reality" }] : []),
    ...(study.id === 3 ? [{ id: "section-reframing", label: "Reframing" }] : []),
    ...(study.id === 3 ? [{ id: "section-app-editions", label: "Editions" }] : []),
    ...(study.id === 3 ? [{ id: "section-scope-initiative", label: "Scope" }] : []),
    ...(study.id === 3 ? [{ id: "section-focus-case-study", label: "Focus" }] : []),
    ...(study.id === 3 ? [{ id: "section-experience-transformation", label: "UX Design" }] : []),
      ...
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-400 px-6 md:px-24 flex items-center justify-between ${
          headerScrolled && headerHovered
            ? "py-4 opacity-100 translate-y-0 bg-[#F5F5F7]/80 backdrop-blur-md border-b border-[#2D2D2D]/10 shadow-sm pointer-events-auto"
