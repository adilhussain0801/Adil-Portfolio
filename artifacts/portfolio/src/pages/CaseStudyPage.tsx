...
import { ArrowLeft, ArrowRight, ArrowUpRight, Quote, Inbox, SearchCode, Clock, Repeat2, Search, Brain, Zap, FileText, Clock as ClockIcon, TrendingDown, AlertTriangle, Lightbulb, Sparkles, RefreshCw, Network, MessageSquare, ChevronLeft, ChevronRight, X, CheckCircle2, Settings, Receipt, Layers } from "lucide-react";
        ...
        <div className="h-screen snap-start snap-always flex flex-col justify-center py-16">
          <div className="max-w-5xl mx-auto w-full px-6 flex flex-col gap-8">
            ...
            <SnapReveal delay={0.15} className="flex gap-4">
              {[
                { value: "$15–$50", label: "Average cost per ticket", color: "#E8654B", bg: "#FEF0EC", border: "rgba(232,101,75,0.18)", icon: <Receipt size={16} /> },
