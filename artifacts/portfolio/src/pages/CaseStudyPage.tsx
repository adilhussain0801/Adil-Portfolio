    ...
    >
      <SnapReveal>
        <div className="flex flex-col gap-5">
          ...
          {/* Journey image — full width */}
          <div
            className="w-full overflow-x-auto overflow-y-hidden border-t border-b"
          ...
          >
            <img
              ...
              className="block"
              style={{ height: 420, width: "auto", maxWidth: "none", padding: "20px 40px" }}
            />
          </div>
        </div>
      </SnapReveal>
...
function AppEditionsSolutionSection() {
  ...
  const capabilities = [
    ...
    { icon: <Target size={14} strokeWidth={1.6} />, label: "Align pricing with value", color: "#16A34A" },
  ];
  return (
    <section
